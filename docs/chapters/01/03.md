...
## 1.3.1 Capabilities vs. Intelligence {: #01 }
...
## 1.3.2 Definitions of advanced AI Systems {: #02 }
...
<script>
    document.addEventListener('DOMContentLoaded', async () => {
        await embedHtmlAtEnd('../../../quizzes/html/02.03.html');
        setup_drag_drop();
        });
